...
#$OnscreenOutput = @{$VMName,$NumCPU,$MemoryMB,$HDDSize,$VMOS}
...
Else
{
	If (($Export -ne "Yes"))
	{
		get-vm $VM | ft $VMName,$NumCPU,$MemoryMB,$HDDSize,$VMOS -auto -wrap
	}
	Else
	{
		get-vm $VM | Select-Object $VMName,$NumCPU,$MemoryMB,$HDDSize,$VMOS | Export-Csv $FullPath;
